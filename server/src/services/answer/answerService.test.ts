...
describe('answer mutations', () => {
  ...
  it('should be able to edit the answer', async () => {
  ...
  it('should throw an error if question related to new answer is not made by authorized user', async () => {
  ...
  it('should throw an error if answer that is wanted to update is not made by authorized user', async () => {
  ...
  it('should be able to delete the answer if there are more than one answer related to that question', async () => {
    const initial = await testServer.executeOperation({ query: answersQuery.query });
  ...
  it('should throw an error if answer that is wanted to delete is not made by authorized user', async () => {
