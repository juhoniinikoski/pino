...
describe('testing question queries', () => {
  it('should return a list of questions of a certain channel', async () => {
  ...
  it('should return a list of questions of a certain stack', async () => {
  ...
  it('should get all questions made by authorized user', async () => {
...
describe('question mutation', () => {
  ...
  it('should update the question if it is made by authorized user', async () => {
  ...
  it("shouldn't update the question due to unauthorized user", async () => {
  ...
  it('should throw an error if the question wanted to delete is not made by the authorized user', async () => {
    const initial = await testServer.executeOperation({ query: userQuery.query });
  ...
  it('should delete a question and its answers succesfully', async () => {
    const initial = await testServer.executeOperation({ query: userQuery.query });
    const initialAnswersLength = (await Answer.query()).length;
